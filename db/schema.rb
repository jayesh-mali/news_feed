...
ActiveRecord::Schema.define(version: 2019_07_28_123118) do
  ...
  create_table "news_feeds", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["created_by_id"], name: "index_news_feeds_on_created_by_id"
    t.index ["postable_type", "postable_id"], name: "index_news_feeds_on_postable_type_and_postable_id"
  end
  ...
  add_foreign_key "news_feeds", "users", column: "created_by_id"
